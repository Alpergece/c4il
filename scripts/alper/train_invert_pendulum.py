...
def experiment(alg, env_id, horizon, gamma, n_epochs, n_steps, n_steps_per_fit, n_episodes_test,
    ...
    # Save the weights to a data/weights directory
    if not os.path.exists('/home/alper/c4il/data/weights/'):
        os.makedirs('/home/alper/c4il/data/weights/')
    # with open('/home/alper/c4il/data/weights/weights.pkl', 'wb') as f:
    #    pickle.dump(agent.policy.get_weights(), f)
    torch.save(agent.policy.get_weights(), '/home/alper/c4il/data/weights/weights.pt')
